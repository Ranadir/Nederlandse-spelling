...
- **Heel / Hele (als bijvoeglijk naamwoord - 'volledig')**: Wanneer het direct iets zegt over een zelfstandig naamwoord, betekent het 'volledig' of 'niet aangesneden'. In dat geval wordt het wel verbogen.
    - *Wel*: Ik heb een **hele**, mooie taart gekocht. (In de betekenis: De taart is *volledig* en toevallig ook mooi).
    - *Wel*: De **hele** dag regende het.
    - *Wel*: Ik heb een **heel** brood gekocht.
...
- **Email (materiaal)**: Uitgesproken als 'ee-maj', een glasachtige laag op bijv. pannen.
    - Bijvoeglijk naamwoord: **Emaillen** (*een emaillen schaaltje*). Dit betekent 'met email bedekt'.
    - Werkwoord: **Emailleren** (*een geëmailleerde pan*).
    - *Foutief*: De vorm 'emaille' is onjuist.
...
- **Maar (voegwoord)**: Staat altijd vooraan in een de (bij)zin. Er komt **geen** komma achter.
    - *Wel*: Ik wilde kersenijs, **maar** kreeg aardbeienijs.
- **Echter (bijwoord)**: Kan op verschillende plaatsen staan.
    - **Midden in de zin**: Geen komma's nodig (*Dit bleek echter niet te kloppen*).
    - **Vooraan de zin**: Altijd gevolgd door een komma (*Echter, dit bleek niet te kloppen*).
- **Foutief**: Gebruik ze nooit allebei in dezelfde zin (*maar nu merk ik echter dat...*). Dit is dubbelop.
